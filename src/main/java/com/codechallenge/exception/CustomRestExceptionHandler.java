...
import com.codechallenge.model.ApiError;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleNoAccountException(final NoAccountException ex, final WebRequest request) {
	...
	public ResponseEntity<Object> handleNoFundsException(final NoFundsException ex, final WebRequest request) {
		final String error = ex.getMessage();
